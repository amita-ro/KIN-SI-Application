...
import com.example.kin_si.Adapter.OnBoardingViewAdapter
import com.example.kin_si.Adapter.OnBoardingViewItem
...
class OnboardingFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val onBoardingPageLists = listOf<OnBoardingViewItem>(
            OnBoardingViewItem("KIN-SI Food Order", "Better Food Better Mood.", R.drawable.onboarding1),
            OnBoardingViewItem("KIN-SI Fast Delivery", "GOOD FOOD is all the sweeter when shared with GOOD FRIENDS.", R.drawable.onboarding2),
            OnBoardingViewItem("KIN-SI Good Service", "You waste life when you weste good food.", R.drawable.onboarding3)
        )
        ...
        goBtn.setOnClickListener{
            // Nothing to do here
            navController.navigate(R.id.action_onboardingFragment2_to_signInActivity);
        }
    }
